...
- **Frontend Development (apps/web):**
  - **กฎเหล็กสูงสุด:** การทำงานในส่วน Frontend ทุกอย่าง **ต้องยึดถือและปฏิบัติตาม `Table of Contents for Frontend Developer only` เป็นคัมภีร์หลักอย่างเคร่งครัด 100%** ห้ามนำเสนอโครงสร้างหรือวิธีการอื่นที่ขัดกับไฟล์ดังกล่าวโดยเด็ดขาด
  ...
  - **Naming & Folder Structure:** ต้องเป๊ะตามที่ `Table of Contents for Frontend Developer only` กำหนดไว้ทุุกประการ
...
- **Research First:**
- **Research First:** ไม่ว่าจะเป็นการเพิ่มฟีเจอร์ใหม่, การแก้ไขบั๊ก หรือการปรับปรุงระบบ (Refactoring) ต้องทำการค้นคว้าและอ่านเอกสารที่เกี่ยวข้องในโปรเจกต์ (เช่น ในโฟลเดอร์ `docs/` และ `Table of Contents for Frontend Developer only`) เพื่อทำความเข้าใจกฎเกณฑ์และสถาปัตยกรรมก่อนลงมือทำเสมอ
