...
import { CreateExpenseFormValues } from "../schemas/expense.schema";
...
interface ExpenseFormProps {
  ...
  handleSubmit: UseFormHandleSubmit<CreateExpenseFormValues>;
...
export default function ExpenseForm({
  ...
  // ponytail: filter expense categories only on the frontend side too
