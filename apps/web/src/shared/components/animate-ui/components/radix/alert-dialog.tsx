...
} from "@/shared/components/animate-ui/primitives/radix/alert-dialog";
import { buttonVariants } from "@/shared/components/animate-ui/components/buttons/button";
  ...
  return (
    <AlertDialogPortalPrimitive>
      ...
      <AlertDialogContentPrimitive
        className={cn(
          "fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2.5rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-2xl border border-border bg-surface p-6 shadow-2xl text-primary-text sm:max-w-md",
          className,
        )}
        {...props}
      />
