...
} from "@/shared/components/animate-ui/primitives/radix/dropdown-menu";
...
function DropdownMenuContent({
  ...
  return (
    <DropdownMenuContentPrimitive
      ...
      className={cn(
        "bg-surface text-primary-text z-50 max-h-64 min-w-32 overflow-x-hidden overflow-y-auto rounded-xl border border-border p-1 shadow-lg outline-none",
        className,
      )}
      {...props}
    >
      <DropdownMenuHighlightPrimitive className="absolute inset-0 bg-surface-secondary z-0 rounded-lg pointer-events-none">
        {children}
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuHighlightItemPrimitive
      activeClassName={
        variant === "destructive" ? "bg-expense-light/50 text-expense" : ""
      }
      disabled={disabled}
    >
      <DropdownMenuItemPrimitive
        ...
        className={cn(
          "relative flex cursor-pointer items-center gap-2 rounded-lg px-2.5 py-1.5 text-sm outline-none select-none transition-colors data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 data-highlighted:bg-surface-secondary/80 data-inset:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
          variant === "destructive" && "text-expense",
          className,
        )}
        {...props}
      />
  ...
  return (
    <DropdownMenuHighlightItemPrimitive disabled={disabled}>
      <DropdownMenuCheckboxItemPrimitive
        disabled={disabled}
        className={cn(
          "relative flex cursor-pointer items-center gap-2 rounded-lg py-1.5 pr-2 pl-8 text-sm outline-none select-none transition-colors data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 data-highlighted:bg-surface-secondary/80 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
          checked && "font-medium",
          className,
        )}
        checked={checked}
...
function DropdownMenuShortcut({
  ...
  return (
    <DropdownMenuShortcutPrimitive
      className={cn(
        "text-secondary-text ml-auto text-xs tracking-widest",
        className,
      )}
      {...props}
    />
  ...
  return (
    <DropdownMenuHighlightItemPrimitive disabled={disabled}>
      <DropdownMenuSubTriggerPrimitive
        ...
        data-inset={inset}
        className={cn(
          "flex cursor-pointer items-center rounded-lg px-2 py-2 text-sm outline-none select-none transition-colors data-inset:pl-8 data-highlighted:bg-surface-secondary/80",
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuSubContentPrimitive
      className={cn(
        "bg-surface text-primary-text z-50 min-w-32 overflow-hidden rounded-xl border border-border p-1 shadow-lg outline-none",
        className,
      )}
      {...props}
    >
...
export {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuHighlightPrimitive as DropdownMenuHighlight,
  DropdownMenuContent,
  DropdownMenuItem,
  DropdownMenuItemIndicatorPrimitive as DropdownMenuItemIndicator,
  DropdownMenuHighlightItemPrimitive as DropdownMenuHighlightItem,
