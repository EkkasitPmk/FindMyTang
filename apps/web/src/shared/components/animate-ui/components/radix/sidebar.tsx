...
const sidebarMenuButtonActiveVariants = cva(
  "bg-surface-secondary text-primary-text rounded-xl",
  {
    variants: {
      variant: {
        default: "bg-surface-secondary text-primary-text",
        outline:
          "bg-surface-secondary text-primary-text shadow-[0_0_0_1px_var(--sidebar-accent)]",
      },
    },
    defaultVariants: {
      variant: "default",
