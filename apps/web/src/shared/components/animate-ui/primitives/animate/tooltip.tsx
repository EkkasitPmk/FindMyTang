...
function TooltipPortal(props: Readonly<TooltipPortalProps>) {
...
function TooltipOverlay() {
  ...
  const [prevTooltip, setPrevTooltip] = React.useState<TooltipData | null>(
    null,
  );

  if (currentTooltip !== prevTooltip) {
    setPrevTooltip(currentTooltip);
    if (currentTooltip) {
