...
import { useControlledState } from "@/shared/lib/hooks/use-controlled-state";
...
function Collapsible(props: Readonly<CollapsibleProps>) {
...
function CollapsibleTrigger(props: Readonly<CollapsibleTriggerProps>) {
  return (
